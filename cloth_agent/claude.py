...
class ClaudeCodeClient:
    ...
    def invoke(self, prompt: str, workspace: Path) -> ClaudeResult:
        ...
        system_prompt = (
            ...
            "yourself. The objective is to make the garment as open and spread as safely "
            "possible; a lifting anchor is an intermediate tool, not the terminal goal. Use "
            "a minimal cautious test only when uncertainty blocks a grounded opening action. Do not require semantic "
