...
class AgentSession:
    ...
    def invoke_claude_code(self, prompt: str, *, experiment_name: str | None = None) -> ClaudeResult:
        ...
        context = (
            ...
            "The research objective is to autonomously search for a usable garment "
            "lifting anchor. A usable anchor supports a useful hanging configuration "
            "that can later be laid down for easier perception/manipulation. Do not "
            ...
            "An exploratory script may perform a minimal cautious test of a possible "
            "anchor and does not have to complete a full reveal trajectory. If the "
